  ...
  <nav class="navbar navbar-default" role="navigation">
    ...
    <?php if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']){?>
        <ul class="nav navbar-nav navbar-right">
          ...
          <li>
            <a class="menu_active" href="<?php echo site_url('admin/state_management');?>">State Master</a>
          </li>
          <li>
            <a class="menu_active" href="<?php echo site_url('admin/city_management');?>">City Master</a>
          </li>
          <li>
