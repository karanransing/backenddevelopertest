    ...
    {   
       ...
       $this->form_validation->set_rules('city', 'City', 'required|callback_unique_city[0]',array('unique_city' => 'This %s Already Exist!'));
        ...
        { 
            ...
            if($insertFlag)
            {
                $result = array('status'=>true,'msg'=>'New City Added!');
            }
            else
            {
                $result = array('status'=>false,'msg'=>'Unable to Add New City Something Went Wrong Please Try Again!');
            }
        } 
    ...
    {   
        ...
        {   
            ...
            { 
                ...
                if($insertFlag)
                {
                    $result = array('status'=>true,'msg'=>'City Details Updated!');
                }
                else
                {
                    $result = array('status'=>false,'msg'=>'Unable to Update State Name Something Went Wrong Please Try Again!');
                }
            }
        }
        else
        {
            $result = array('status'=>false,'msg'=>'City Id Blank!');
        }
